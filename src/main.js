import h from './vdom/createVirtualElement';
import render from './vdom/render';
import mount from './vdom/mount';
import diff from './vdom/diff';
import createApp from './vdom/createApp';
...
const app = createApp(h('div', {
    ...
    children: [
        h('Text', {
            textContent: "Titolo Immagine"
        }),
        h('Comment', {
            textContent: "Commento"
        }),
        h('Text', {
...
const { root } = app;
let { _app: virtualDOM } = app;

setInterval(() => {
    counter++;

    let newVirtualDOM = h('div', {
        attributes: {
            id: "app"
        },
        children: [
    ...
    const patch = diff(virtualDOM, newVirtualDOM);
